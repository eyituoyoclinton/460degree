...
?>
                                    ...
                                    <div class="col-lg-6 col-sm-6 col-12">
                                        ...
                                        <form>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="email" class="form-control" id="email" placeholder="john@dow.com">
                                            </div>
                                            <div class="form-group">
    ...
    foreach ($userRole as $key) {
        ?>
                                            ...
                                            <button type="submit" class="btn btn-primary btn-lg add_account_click">Add user</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
